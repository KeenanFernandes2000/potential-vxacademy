  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="bg-white bg-opacity-90 backdrop-blur-sm z-50 sticky top-0 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#about"
              className="text-abu-charcoal hover:text-[#009086] transition-colors"
            >
              About
            </a>
            <a
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-2 space-y-2">
              <a
                href="#about"
                className="block py-2 text-abu-charcoal hover:text-[#009086]"
              >
                About
              </a>
              <a
              ...
              {user ? (
                <Link href="/dashboard">
                  <Button className="w-full bg-[#009086] hover:bg-[#009086]/90 text-white rounded-xl mt-2">
                    My Dashboard
                  </Button>
                </Link>
              ) : (
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#009086] to-[#003451]" />
          ...
          <div className="max-w-2xl text-white my-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <a href="#about">
                <Button
                  variant="outline"
                  className="bg-transparent border-white text-white hover:bg-white/20 text-lg py-6 px-8 rounded-xl"
                >
                  Learn More
                </Button>
              </a>
      ...
      <section
        id="about"
        className="py-24 bg-abu-sand relative overflow-hidden"
      >
            ...
            <div className="lg:w-1/2 space-y-8">
              <div className="space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold text-abu-charcoal leading-tight">
                  <span className="text-[#009086]">VX Academy</span> -
              ...
              <div className="grid grid-cols-2 gap-6 pt-4">
                <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl hover:bg-white/80 transition-all duration-300 hover:scale-105">
                  ...
                  <p className="text-abu-charcoal font-medium">
                    Certified Training
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="group">
                  <div className="bg-gradient-to-br from-white to-[#009086]/5 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-[#009086]/10">
                    ...
                    <h4 className="text-abu-charcoal font-bold text-xl mb-3">
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl font-bold text-abu-charcoal">
                Training Areas
              </h2>
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/30 hover:scale-105 h-full">
                <div className="w-20 h-20 bg-gradient-to-br from-[#009086]/10 to-[#009086]/20 rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 mx-auto">
                  <svg
                    className="w-10 h-10 text-[#009086]"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <div className="text-center space-y-4">
                  <h3 className="text-xl font-bold text-abu-charcoal group-hover:text-[#009086] transition-colors duration-300">
                    Abu Dhabi Information
                  </h3>
                  <p className="text-abu-charcoal text-sm leading-relaxed">
                    Discover the heart of Abu Dhabi. This training area immerses
                    frontline professionals in the emirate's rich cultural
                    heritage, tourism strategy, and infrastructure.
                  </p>
                  <div className="pt-4">
                    <a
                      href="#"
                      className="inline-flex items-center text-[#009086] font-semibold text-sm hover:text-[#003451] transition-colors group-hover:translate-x-1 transform duration-300"
                    >
                      Learn More
                      <svg
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/30 hover:scale-105 h-full">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-abu-charcoal text-sm leading-relaxed">
                    Master the art of human connection. This track builds
                    communication, empathy, and service delivery skills that
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/30 hover:scale-105 h-full">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-abu-charcoal text-sm leading-relaxed">
                    Operational excellence starts here. This training sharpens
                    the technical and procedural capabilities needed to manage
                    visitor flows and uphold safety standards.
                  </p>
                  <div className="pt-4">
                    <a
                      href="#"
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/30 hover:scale-105 h-full">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-abu-charcoal text-sm leading-relaxed">
                    Lead with purpose. Designed for supervisors and team
                    leaders, this area builds leadership, strategic planning,
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/30 hover:scale-105 h-full">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-abu-charcoal text-sm leading-relaxed">
                    Tailored for your role. These advanced, sector-specific
                    programs provide deep expertise for specialized frontline
                    positions across Abu Dhabi's visitor landscape.
                  </p>
                  <div className="pt-4">
                    <a
                      href="#"
      ...
      <section
        id="benefits"
        className="py-24 bg-gradient-to-br from-[#009086] to-[#003451] text-white relative overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                <div className="w-16 h-16 bg-[#00d8cc] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <svg
                    className="w-8 h-8 text-abu-charcoal"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-[#00d8cc] transition-colors duration-300">
                  Recognized Certification
                </h3>
                <p className="opacity-90 leading-relaxed">
                  Earn a prestigious certification recognized by VX Academy and
                  Abu Dhabi's frontline hospitality and tourism sector.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Enhance your resume and open doors to new career opportunities
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Earn digital badges to recognize your skills and showcase your
                  hospitality expertise to employers and colleagues.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Connect with fellow professionals across Abu Dhabi's
                  hospitality and tourism Cluster's network of facilities.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Access courses anytime, anywhere through our mobile-friendly
                  platform with online and offline capabilities.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Get personalized help from our AI tutor to enhance your
                  learning experience and address questions.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 h-full">
                ...
                <p className="opacity-90 leading-relaxed">
                  Engage with immersive content, simulations, and real-world
                  scenarios for a dynamic learning experience.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/20 hover:scale-105 h-full">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-abu-primary font-medium">
                      Hotel Concierge
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-abu-charcoal leading-relaxed -mt-4">
                    VX Academy transformed how I assist guests at our hotel. The
                    cultural knowledge modules helped me provide authentic
                    recommendations that guests truly appreciate.
                  </p>
            ...
            <div className="group">
              <div className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/20 hover:scale-105 h-full">
                ...
                <div className="space-y-6">
                  <div className="text-3xl text-[#009086] leading-none">"</div>
                  <p className="text-abu-charcoal leading-relaxed -mt-4">
                    The destination knowledge courses were incredibly detailed.
                    I now confidently share hidden gems and fascinating stories
                    about Abu Dhabi that my tour groups love.
                  </p>
                  <div className="flex text-abu-gold space-x-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
            ...
            <div className="group">
              <div className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#009086]/20 hover:scale-105 h-full">
                ...
                <div className="space-y-6">
                  <div className="text-3xl text-[#009086] leading-none">"</div>
                  <p className="text-abu-charcoal leading-relaxed -mt-4">
                    The communication skills modules helped me connect better
                    with international customers. My sales have increased, and
                    I've received recognition from management.
                  </p>
                  <div className="flex text-abu-gold space-x-1">
                    {[...Array(4)].map((_, i) => (
                      <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="space-y-6">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#009086] flex items-center justify-center transition-all duration-300 hover:scale-110 group"
                >
                  <svg
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#"
                    className="opacity-80 hover:opacity-100 hover:text-abu-gold transition-all duration-300 hover:translate-x-1 transform inline-block"
                  >
                    About Us
                  </a>
                </li>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3 group">
                  ...
                  <span className="opacity-80 text-sm">info@vxacademy.ae</span>
                </div>
                <div className="flex items-start space-x-3 group">
                  <div className="w-6 h-6 bg-[#00d8cc]/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-[#00d8cc]/40 transition-colors">
                    <svg
