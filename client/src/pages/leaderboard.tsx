                ...
                <TabsContent value="global">
                  <div className="overflow-hidden rounded-lg border border-neutrals-200">
                    <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white grid grid-cols-12 gap-4 py-3 px-4">
                      ...
                      <div className="col-span-8 md:col-span-6 font-medium">
                        Name
                      </div>
                ...
                <TabsContent value="department">
                  <div className="mb-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="hotel-operations">
                          Hotel Operations
                        </SelectItem>
                        <SelectItem value="tourism-services">
                          Tourism Services
                        </SelectItem>
                        <SelectItem value="guest-relations">
                          Guest Relations
                        </SelectItem>
                        <SelectItem value="food-beverage">
                          Food & Beverage
                        </SelectItem>
                        <SelectItem value="events-management">
                          Events Management
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div className="overflow-hidden rounded-lg border border-neutrals-200">
                    <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white grid grid-cols-12 gap-4 py-3 px-4">
                      ...
                      <div className="col-span-7 md:col-span-5 font-medium">
                        Name
                      </div>
                      <div className="hidden md:block md:col-span-3 font-medium">
                        Department
                    ...
                    {isLoading ? (
                      ...
                      <div className="py-12 text-center">
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-neutrals-600">
                            No users found for the selected department.
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  <>
                    <div className="flex items-baseline">
                      <span className="text-3xl font-bold text-primary">
                        {leaderboard.findIndex((u) => u.id === currentUser.id) +
                          1}
                      </span>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                {isLoading ? (
                  ...
                  (() => {
                    ...
                    const pointsNeeded =
                      (leaderboard[userIndex - 1]?.xpPoints || 0) -
